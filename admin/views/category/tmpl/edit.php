...
?>
<form enctype="multipart/form-data"  action="<?php echo JRoute::_('index.php?option=com_vipquotes&layout=edit&id='.(int) $this->item->id); ?>" 
method="post" name="adminForm" id="category-form" class="form-validate">
    <div class="width-40 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_("COM_VIPQUOTES_CATEGORY_INFORMATION"); ?></legend>
...
<div>
    <img src="<?php echo (JURI::root() . "media/com_vipquotes/images/remove_image.gif"); ?>" alt="<?php echo $this->item->name;?>" />
    <a href="<?php echo JRoute::_("index.php?option=com_vipquotes&amp;task=category.removeImage&amp;id=" . $this->item->id); ?>" ><?php echo JText::_("COM_VIPQUOTES_DELETE_IMAGE")?></a>
</div>
<?php }?>