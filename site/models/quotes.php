...
class VipQuotesModelQuotes extends JModelList {
    ...
    protected function populateState($ordering = 'ordering', $direction = 'ASC'){
        ...
        // Set limit
        $value             = $params->get("quotes_quotes_limit", $app->getCfg('list_limit', 20));
    ...
    public function getListQuery(){
        ...
        $query->leftJoin($db->quoteName("#__categories") . " AS d ON a.catid = d.id");
    ...
    protected function prepareFilterAlpha($query, $alpha) {
        ...
        } else if(!empty($filterCategoryAlpha)) {
