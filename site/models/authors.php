...
class VipQuotesModelAuthors extends JModelList
{
    ...
    protected function populateState($ordering = 'ordering', $direction = 'ASC')
    {
        ...
        // Set limit
        $value = $params->get("authors_limit", $app->get('list_limit', 20));
        ...
        // Ordering
        $filterOrdering = (int)$app->getUserStateFromRequest($this->context . "filter.ordering", "filter_author_ordering", 0);
