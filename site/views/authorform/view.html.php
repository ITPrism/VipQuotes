...
class VipQuotesViewAuthorForm extends JViewLegacy
{
    /**
     * @var JDocumentHtml
     */
    ...
    protected function prepareDocument()
    {
        ...
        if (!$this->params->get("page_heading")) {
            if ($menu) {
                ...
                $this->params->def('page_heading', JText::_('COM_VIPQUOTES_DEFAULT_PAGE_TITLE_AUTHOR_FORM'));
            }
        }
        ...
        if ($menu) {
            ...
            $pathway->addItem(JText::_('COM_VIPQUOTES_DEFAULT_PAGE_TITLE_AUTHOR_FORM'));
        }
